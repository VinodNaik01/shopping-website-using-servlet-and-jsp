...
try {
    ...
    PreparedStatement st = con.prepareStatement("SELECT * FROM orders INNER JOIN product where orders.product_id = product.id and orders.order_date is not null and orders.status='cancelled'");
